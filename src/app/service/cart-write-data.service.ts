...
export class CartWriteData
{
    ...
    putCartData(UID: string)
    {
      ...
      return this.http.put('https://blaze-athletics-firebase-default-rtdb.firebaseio.com/cartData/' + UID +'.json', productData);  
    }

    getCartData(UID: string)
    {
     return this.http.get<ProductDataModel[]>('https://blaze-athletics-firebase-default-rtdb.firebaseio.com/cartData/' + UID +'.json');
    }
}
